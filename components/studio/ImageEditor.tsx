...
import { Brush, Undo, Trash2, X, Loader2, Wand2, RotateCcw, Sparkles, Shirt, Download } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-lg z-50 flex items-center justify-center p-4 animate-fade-in duration-300">
            <div className="bg-zinc-925/70 backdrop-blur-xl rounded-xl border border-white/10 shadow-glass w-full max-w-6xl h-full max-h-[90vh] flex flex-col shadow-glass-inset">
                ...
                <div className="flex-grow flex flex-col lg:flex-row gap-6 p-4 sm:p-6 min-h-0">
                    ...
                    {/* Image Viewer */}
                    <div className="flex-grow bg-black rounded-lg relative flex items-center justify-center overflow-hidden border border-white/10 min-h-[250px] lg:min-h-0 group/canvas">
                        <img 
                            ref={imageRef} 
                            src={imageToEdit} 
                            alt="Image to edit" 
                        ...
                        {hasBeenEdited && !isApplyingEdit && (
                            <button
                                onClick={handleDownloadResult}
                                className="absolute top-4 right-4 z-20 bg-violet-600 hover:bg-violet-500 text-white p-2.5 rounded-lg shadow-xl border border-white/20 transition-all duration-200 hover:scale-105 flex items-center gap-2"
