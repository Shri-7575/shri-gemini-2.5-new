...
import { Lightbulb, Check, Loader2, X, Sparkles } from 'lucide-react';
...
export const AIEnhancements: React.FC = () => {
    ...
    return (
        <div className="mt-4 animate-fade-in overflow-hidden pb-32 sm:pb-20">
            ...
            <div className="flex gap-4 overflow-x-auto pb-6 -mx-4 px-4 model-filter-scrollbar">
            ...
            {/* Motivational Line & Extra Negative Space */}
            <div className="mt-6 px-2 animate-fade-in delay-500">
                <div className="flex items-center gap-2 text-violet-400/60 mb-2">
                    <Sparkles size={14} />
                    <span className="text-[10px] font-black uppercase tracking-widest">Creator Insight</span>
                </div>
                <p className="text-xs text-zinc-500 italic leading-relaxed max-w-xs">
                    Mastering these concepts is the key to unlocking true creative freedom. By understanding how lighting, angles, and poses interact, you can transform simple ideas into professional, high-impact brand visuals every time.
                </p>
            </div>
        </div>
    );
