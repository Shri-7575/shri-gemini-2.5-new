...
// FIX: Add 'lite-studio' to StudioMode to support the Lite Studio.
// FIX: Add 'edit-studio' to StudioMode to allow switching to the new Edit Studio.
// FIX: Add 'social-studio' to StudioMode to allow switching to the new Social Post Studio.
export type StudioMode = 'apparel' | 'product' | 'design' | 'reimagine' | 'product-scene-generator' | 'photoshoot' | 'chat' | 'logo-studio' | 'lite-studio' | 'edit-studio' | 'social-studio';
...
// FIX: Add missing Social types and update SocialStudioState to resolve import errors in socialStore.ts and SocialStudio.tsx.
