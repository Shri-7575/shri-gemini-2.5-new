...
import { createLiteStudioSlice, LiteStudioSlice } from './liteStudioStore';
import { createEditStudioSlice, EditStudioSlice } from './editStudioStore';
import { createSocialSlice, SocialSlice } from './socialStore';
 ...
 */
export type StudioStore = ApparelSlice & ProductSlice & DesignSlice & ReimagineSlice & SharedSlice & PhotoshootSlice & ChatSlice & LiteStudioSlice & EditStudioSlice & SocialSlice;
...
export const useStudio = create<StudioStore>()((...a) => ({
    ...
    ...createChatSlice(...a),
    ...createLiteStudioSlice(...a),
    ...createEditStudioSlice(...a),
    ...createSocialSlice(...a),
}));