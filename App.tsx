...
import LiteStudio from './components/lite_studio/LiteStudio';
import EditStudio from './components/edit_studio/EditStudio';
...
const AppContent: React.FC = () => {
    ...
    if (studioMode === 'lite-studio') {
        return <LiteStudio onBack={() => setStudioMode('apparel')} />;
    }

    if (studioMode === 'edit-studio') {
        return <EditStudio onBack={() => setStudioMode('apparel')} />;
    }

    if (studioMode === 'social-studio') {
        return <SocialStudio onBack={() => setStudioMode('apparel')} />;
    }
